...
class RGTAN(nn.Module):
    ...
    # The forward pass no longer accepts `labels` as an argument for feature creation.
    def forward(self, blocks, features, n2v_feat=None, neighstat_feat=None):
        ...
        # The loop now iterates from layer 0 of the modified self.layers
        for l in range(self.n_layers):
            h = self.output_drop(self.layers[l](blocks[l], h))
